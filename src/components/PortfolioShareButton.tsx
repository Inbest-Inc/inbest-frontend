...
export default function PortfolioShareButton({
  ...
  const handleShareClick = () => {
    ...
    const url = `${origin}/${username}/${portfolioId}`;
    setShareUrl(url);
  };
  ...
  const shareTitle = `Check out @${username}'s investment portfolio on Inbest!`;
  const shareDescription = `Follow along with ${username}'s investment strategy and track portfolio performance on Inbest - the social investing platform.`;
