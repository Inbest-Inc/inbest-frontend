...
export default function UserProfilePage() {
  ...
  useEffect(() => {
    const fetchPortfolios = async () => {
      ...
      try {
        console.log("Fetching portfolios for username:", username);
        ...
        if (response.status === "success" && response.data) {
          ...
          console.error("Failed to load portfolios:", response);
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50/50 to-white p-4">
